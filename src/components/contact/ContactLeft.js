...
const ContactLeft = () => {
  return (
    <div className="w-full lgl:w-[35%] h-full bg-white p-4 lgl:p-8 rounded-lg shadow-lg flex flex-col gap-8 justify-center">
      <img
      ...
      <div className="flex flex-col gap-4">
        <h3 className="text-3xl font-bold text-black">Abdiaziz Mohamed</h3>
        ...
        <p className="text-base text-gray-500 flex items-center gap-2">
          Phone: <span className="text-black"><a href="+254721707044">+254721707044</a></span>
        </p>
        <p className="text-base text-gray-500 flex items-center gap-2">
          Email: <span className="text-black">abdiaziz.xakim@gmail.com</span>
        </p>
      </div>
      <div className="flex flex-col gap-4">
