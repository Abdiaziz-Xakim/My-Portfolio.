...
const Navbar = () => {
  ...
  return (
    <div className="w-full h-24 sticky top-0 z-50 bg-bodyColor mx-auto flex justify-between items-center font-titleFont border-b-[1px] border-b-gray-600">
        <div>
            <img src={logo} alt="logo" class="w-25 h-20" />
        </div>
      <div>
        ...
        <span
          ...
          className="text-xl mdl:hidden bg-white w-10 h-10 inline-flex items-center justify-center rounded-full text-designColor cursor-pointer"
        >
          <FiMenu />
        </span>
        {showMenu && (
          <div className="w-[80%] h-screen overflow-scroll absolute top-0 left-0 bg-white p-4 scrollbar-hide">
            <div className="flex flex-col gap-8 py-2 relative">
              ...
              <div className="flex flex-col gap-4">
                <h2 className="text-black uppercase font-titleFont mb-4">
                  Find me in
                </h2>
